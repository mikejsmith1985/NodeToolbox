...
export const SHAREPOINT_RELAY_BOOKMARKLET_CODE = [
  ...
  'function siteRootOfPath(requestPath){var siteMatch=/^(\/sites\/[^\/]+)/.exec(requestPath);return siteMatch?siteMatch[1]:"";}',
