...
function buildNode(overrides: Partial<CanvasNode> = {}): CanvasNode {
  return {
    ...
    childStories: [], dependencies: [], businessValue: null, description: null, acceptanceCriteria: null, parkReason: null, storyPlacements: {}, attachments: [], effectivePoints: 5, ...overrides,
  };
}
