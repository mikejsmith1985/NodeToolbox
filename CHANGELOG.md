...
- **Art View — PI Review PDF export**: each team PI Review panel can now download a screenshot-style PDF of the current page, including the Team Capacity snapshot, PI Review table, commitment line, and week-over-week fist-of-five history, so teams can share a clean point-in-time export outside Toolbox.
