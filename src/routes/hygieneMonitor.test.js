        ...
        teams: [
          {
            ...
            teamsWebhookUrl: 'https://hooks.office.com/secret-url',
            teamsWebhookSecret: 'my-secret',
      ...
      teams: [
        {
          ...
          teamsWebhookUrl: 'https://hooks.office.com/checkout',
          teamsWebhookSecret: 'checkout-secret',
