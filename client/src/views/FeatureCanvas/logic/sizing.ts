...
//
// A team that has never pointed work can size features fast with XS–XXL. Those sizes must
...
/** The t-shirt sizes in ascending order (Feature Sizing Guidance), for building size pickers. */
