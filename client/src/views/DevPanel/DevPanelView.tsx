// DevPanelView.tsx — Developer diagnostics: live Jira API telemetry and captured server console logs.
//
// The GitHub-API repo-monitor diagnostics (connectivity validation, credential debug, and the API
// reachability probe) were removed once the GitHub API was confirmed unavailable in this environment; the
// integration now runs through the email-intake path, which is configured and tested from the Admin Hub.
...
/** Renders a Dev Panel with live Jira API telemetry and captured server console output. */
